...
const verify = catchAsync(async (req: TypedRequest<{}, {}>, _res: Response, next: NextFunction) => {
...
const refreshToken = catchAsync(async (req: TypedRequest<{}, {}>, res: Response, _next: NextFunction) => {
  const { user } = req
